...
<div id="app" style="display:none">
  ...
  <nav class="nav-tabs" id="navTabs">
    <div class="nav-tab active" data-page="subscribe" onclick="switchPage('subscribe')">📥 订阅管理</div>
    ...
    <div class="nav-tab" data-page="dashboard" onclick="switchPage('dashboard')">📊 仪表盘</div>
  </nav>
  ...
  <div class="page" id="page-settings">
    ...
    <div class="card" style="margin-top:16px">
      ...
      <div id="catalogTypeFilter" style="display:flex;flex-wrap:wrap;gap:8px;margin-bottom:10px">
        ...
        <button class="catalog-chip" data-type="tld" onclick="setCatalogType(this)">🌍 顶级域 <span class="catalog-chip-count" data-count="tld">0</span></button>
      </div>
      <div class="form-group">
...
window.addEventListener('DOMContentLoaded', async () => {
  // 从 hash 恢复页面
  const savedPage = window.location.hash.replace('#', '') || 'subscribe';
