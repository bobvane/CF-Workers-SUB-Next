...
const RULE_PRESETS = [
  { key: 'mini', label: '🟢 极简', groups: ['ads','china-direct','china-media','media','ai'] },
  { key: 'mini-crypto', label: '🟢 极简+加密', groups: ['ads','china-direct','china-media','media','ai','crypto'] },
  { key: 'standard', label: '🔵 标准', groups: ['ads','china-direct','china-media','media','ai','google-fcm','bing','onedrive','microsoft','apple','game'] },
  { key: 'standard-crypto', label: '🔵 标准+加密', groups: ['ads','china-direct','china-media','media','ai','google-fcm','bing','onedrive','microsoft','apple','game','crypto'] },
